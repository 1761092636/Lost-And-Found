            ...
            <article class="product-classic" data-id="${itemData.lostItemId}">
                ...
                <div class="product-classic-body">
                    ...
                    <div class="product-classic-price price">
                        <div class="price-current" ><input type="hidden" id="reward" value="${itemData.reward}">$${itemData.reward}Wei</div>
                    </div>
                    ...
                    <button  class="btn" onclick="buy(${itemData.lostItemId})" style="background-color: #8EB360"><h4>上报拾得<h4></button>
                </div>
            </article>
        </div>
    `);
