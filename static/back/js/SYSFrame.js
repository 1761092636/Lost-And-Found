...
//*****************************************************************************事件处理
            ...
            $.learuntab = {
                ...
                framemode: function (framename) {
                    ...
                    ;
                    if (framename == "top") {
                        $(settings.menuModule).removeClass("leftModule").addClass("topModule").css({
                            width: "",
                            height: settings.menuheight,
                            float: ""
                        });
                        messageform.removeClass("leftMessage").addClass("topMessage").css({
                            position: "relative",
                            float: "",
                            left: "",
                            width: ""
